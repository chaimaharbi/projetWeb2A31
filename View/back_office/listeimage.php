                ...
                <div class="row">
                    <div class="col-lg-3 col-md-12 col-xs-12 pl-0 pr-0 user-dash">
                        <div class="user-profile-box mb-0">
                            <div class="sidebar-header"><img src="assets/images/logo-blue.svg" alt="header-logo2.png"> </div>                         
                    ...
                    <div class="col-lg-9 col-md-12 col-xs-12 pl-0 user-dash2">
                       <div class="col-lg-12 mobile-dashbord dashbord">
                        ...
                        <section class="user-page section-padding">
            <div class="container-fluid">
                <div class="row justify-content-center align-items-center"> <!-- Ajout de la classe align-items-center pour centrer verticalement -->
                    <div class="col-lg-10"> <!-- Colonne Bootstrap pour le contenu -->
                        ...
                        <div class="detail clearfix">
                            <div class="table-data">
                                <div class="order">
                                    <div class="head">
                                        <h3 class="text-center">Les images</h3> <!-- Centrer le titre -->
                                    </div>
                                            ...
                                            <tbody>
                                                <?php foreach ($tab as $image) { ?>
                                                    <tr>
                                                        ...
                                                        <td><?= $image["statue"]; ?></td>
                                                        <td>
                                                            <a href="deleteimage.php?id=<?= $image['id']; ?>" class="btn btn-sm btn-danger">Supprimer</a>
                                                            <a href="showimage.php?id=<?= $image['id']; ?>" class="btn btn-sm btn-primary">Détails</a>
                                                            <a href="updateimage.php?id=<?= $image['id']; ?>" class="btn btn-sm btn-success">Mise à jour</a>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>

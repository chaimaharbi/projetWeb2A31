                                ...
                                <div class="table-data">
                                    <div class="order">
                                        <div class="head">
                                            ...
                                            <div class="col-md-3">
                                                <a href="listepost.php" class="btn btn-info w-100 py-">Retour à la
                                                    liste</a>
                                            </div>
                                        </div>
                                        <table>
                                                ...
                                                <div class="card-body pt-4 p-3">
                                                    <ul class="list-group">
                                                        <li
                                                            ...
                                                            <img class="card-img-top" src="http://localhost/chaimaprojet/View/front_office/upload/<?= $post["id_image"]; ?>.jpg" alt="Image">

                                                                <h3 class="text">ID post: <?= $post["idpost"]; ?> </h6>
                                                                    <h3 class="text">Date post : <span
                                                                            class="text-dark font-weight-bold ms-sm-2">
                                                                            <?= $post["datepost"]; ?> </span> </h3>
                                                                    <h3 class="text">Email : <span
                                                                            class="text-dark font-weight-bold ms-sm-2">
                                                                            <?= $post["adress"]; ?> </span> </h3>
                                                                    <h3 class="text">Titre : <span
                                                                            class="text-dark font-weight-bold ms-sm-2">
                                                                            <?= $post["titre"]; ?> </span> </h3>
                                                                    <h3 class="text">Description : <span
                                                                            class="text-dark font-weight-bold ms-sm-2">
                                                                            <?= $post["des"]; ?> </span> </h3>
                                                                    <h3 class="text">likes: <span
                                                                            class="text-dark font-weight-bold ms-sm-2">
                                                                            <?= $post["nblike"]; ?> </span> </h3>
                                                                    <h3 class="text">Dislikes: <span
                                                                            class="text-dark font-weight-bold ms-sm-2">
                                                                            <?= $post["nbdislike"]; ?> </span> </h3>

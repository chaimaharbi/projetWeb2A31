...
if (
    ...
    if (
        ...
        // Add reservationtaxi logic
        $imageC->updateimage($image, $_GET['id']);
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-10"> <!-- Colonne Bootstrap pour le contenu -->
                        ...
                        <?php
                        if (isset($_GET['id'])) {
                            $oldimage = $imageC->showimage($_GET['id']);
                            ?>
                            <form  method="POST">
                                            ...
                                            <div class="d-flex flex-column">
                                                ...
                                                <span class="text">
                                                    <input type="text" id="id" name="id"
                                                        value="<?php echo $oldimage['id'] ?>" readonly />
                                                </span>
                                            </div>
                                        </li>
                                    </ul>
                                            ...
                                            <div class="d-flex flex-column">
                                                ...
                                                <span class="text">
                                                         <select id="statue" name="statue">
                                                            <option value="Publiée" <?php if ($oldimage['statue'] == 'Publiée')
                                                                echo 'selected' ?>>Publiée</option>
                                                                 <option value="brouillon" <?php if ($oldimage['statue'] == 'brouillon')
                                                                echo 'selected' ?>>brouillon</option>
                                                                 <option value="en attente de révision" <?php if ($oldimage['statue'] == 'en attente de révision')
                                                                echo 'selected' ?>>en attente de révision</option>
                                                            </select>
                                                </span>
                                            </div>
                                        </li>

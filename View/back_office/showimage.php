                                ...
                                <div class="table-data">
                                    <div class="order">
                                        <div class="head">
                                            ...
                                            <div class="col-md-3">
                                                <a href="listeimage.php" class="btn btn-info w-100 py-">Retour à la
                                                    liste</a>
                                            </div>
                                        </div>
                                        <table>
    ...
    <ul class="list-group">
        <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
            <div class="d-flex flex-column">
                <img class="card-img-top" src="http://localhost/chaimaprojet/View/front_office/upload/<?= $image["id"]; ?>.jpg" alt="Image">
                <h3 class="text">ID image: <?= $image["id"]; ?> </h3>
                <h3 class="text">Nom : <span class="text-dark font-weight-bold ms-sm-2"><?= $image["nom"]; ?> </span> </h3>
                <h3 class="text">Description : <span class="text-dark font-weight-bold ms-sm-2"><?= $image["des"]; ?> </span> </h3>
                <h3 class="text">Date : <span class="text-dark font-weight-bold ms-sm-2"><?= $image["date"]; ?> </span> </h3>
                <h3 class="text">Statue: <span class="text-dark font-weight-bold ms-sm-2"><?= $image["statue"]; ?> </span> </h3>
            </div>
        </li>
    </ul>
</div>

        ...
        <header id="header-container">
            ...
            <style>
                body {
                    ...
                    align-items: center;
                    height: 100vh;
                    /* Assurez-vous que le contenu est centré verticalement sur toute la hauteur de la fenêtre */
                }
                    ...
                    <div id="rev_slider_328_1" class="rev_slider fullwidthabanner" style="display:none;"
                        ...
                        <ul>
                            ...
                            <li data-index="rs-100" data-transition="fade" data-slotamount="default"
                                ...
                                data-description="">
                                <!-- MAIN IMAGE -->
                                <img src="assets/images/slider/slider-1.jpg" alt="" title=""
                                ...
                                <!-- LAYER NR. 23 -->
                                <div class="tp-caption tp-resizeme re-shadow" id="slide-100-layer-23"
                                    data-x="['left','left','left','left']" data-hoffset="['400','330','50','50']"
                                    data-y="['bottom','bottom','bottom','bottom']"
                                    data-voffset="['140','160','350','350']" data-width="none" data-height="none"
                                    data-whitespace="normal" data-visibility="['on','on','off','off']" data-type="image"
                                    ...
                                    data-lasttriggerstate="reset" style="z-index: 27;">
                                    <img src="assets/images/single-property/s-1.jpg" alt=""
                                        data-ww="['640px','640px','360px','360px']"
                                        data-hh="['360px','360px','249px','249']" width="640" height="360"
                                        data-no-retina>
                                </div>
                                <!-- LAYER NR. 24 -->
                                <div class="tp-caption tp-resizeme  re-shadow" id="slide-100-layer-24"
                                    data-x="['left','left','left','left']" data-hoffset="['400','330','50','50']"
                                    data-y="['bottom','bottom','bottom','bottom']"
                                    data-voffset="['140','160','350','350']" data-width="none" data-height="none"
                                    data-whitespace="normal" data-visibility="['on','on','off','off']" data-type="image"
                                    ...
                                    data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]"
                                    data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
                                    data-lasttriggerstate="reset" style="z-index: 28;">
                                    <img src="assets/images/single-property/s-2.jpg" alt=""
                                        data-ww="['640px','640px','360px','360px']"
                                        data-hh="['360px','360px','249px','249']" width="640" height="360"
                                        data-no-retina>
                                </div>
                                <!-- LAYER NR. 25 -->
                                <div class="tp-caption tp-resizeme re-shadow" id="slide-100-layer-25"
                                    data-x="['left','left','left','left']" data-hoffset="['400','330','50','50']"
                                    data-y="['bottom','bottom','bottom','bottom']"
                                    data-voffset="['140','160','350','350']" data-width="none" data-height="none"
                                    data-whitespace="normal" data-visibility="['on','on','off','off']" data-type="image"
                                    ...
                                    data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]"
                                    data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
                                    data-lasttriggerstate="reset" style="z-index: 29;">
                                    <img src="assets/images/single-property/s-3.jpg" alt=""
                                        data-ww="['640px','640px','360px','360px']"
                                        data-hh="['360px','360px','249px','249']" width="640" height="360"
                                        data-no-retina>
                                </div>
                            ...
                            <li data-index="rs-200" data-transition="fade" data-slotamount="default"
                                ...
                                data-description="">
                                <!-- MAIN IMAGE -->
                                <img src="assets/images/slider/slider-2.jpg" alt="" title=""
                                    data-bgposition="right center" data-kenburns="on" data-duration="20000"
                                    data-ease="Linear.easeNone" data-scalestart="110" data-scaleend="110"
                                    data-rotatestart="0" data-rotateend="0" data-blurstart="0" data-blurend="0"
                                    data-offsetstart="0 0" data-offsetend="300 0" data-bgparallax="8"
                                ...
                                <!-- LAYER NR. 23 -->
                                <div class="tp-caption tp-resizeme re-shadow" id="slide-200-layer-23"
                                    data-x="['left','left','left','left']" data-hoffset="['400','330','50','50']"
                                    data-y="['bottom','bottom','bottom','bottom']"
                                    data-voffset="['140','160','350','350']" data-width="none" data-height="none"
                                    data-whitespace="normal" data-visibility="['on','on','off','off']" data-type="image"
                                    ...
                                    data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
                                    data-lasttriggerstate="reset" style="z-index: 27;">
                                    <img src="assets/images/single-property/s-4.jpg" alt=""
                                        data-ww="['640px','640px','360px','360px']"
                                        data-hh="['360px','360px','249px','249']" width="640" height="360"
                                        data-no-retina>
                                </div>
                                <!-- LAYER NR. 24 -->
                                <div class="tp-caption tp-resizeme  re-shadow" id="slide-200-layer-24"
                                    data-x="['left','left','left','left']" data-hoffset="['400','330','50','50']"
                                    data-y="['bottom','bottom','bottom','bottom']"
                                    data-voffset="['140','160','350','350']" data-width="none" data-height="none"
                                    data-whitespace="normal" data-visibility="['on','on','off','off']" data-type="image"
                                    ...
                                    data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
                                    data-lasttriggerstate="reset" style="z-index: 28;">
                                    <img src="assets/images/single-property/s-5.jpg" alt=""
                                        data-ww="['640px','640px','360px','360px']"
                                        data-hh="['360px','360px','249px','249']" width="640" height="360"
                                        data-no-retina>
                                </div>
                                <!-- LAYER NR. 25 -->
                                <div class="tp-caption tp-resizeme re-shadow" id="slide-200-layer-25"
                                    data-x="['left','left','left','left']" data-hoffset="['400','330','50','50']"
                                    data-y="['bottom','bottom','bottom','bottom']"
                                    data-voffset="['140','160','350','350']" data-width="none" data-height="none"
                                    data-whitespace="normal" data-visibility="['on','on','off','off']" data-type="image"
                                    ...
                                    data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
                                    data-lasttriggerstate="reset" style="z-index: 29;">
                                    <img src="assets/images/single-property/s-6.jpg" alt=""
                                        data-ww="['640px','640px','360px','360px']"
                                        data-hh="['360px','360px','249px','249']" width="640" height="360"
                                        data-no-retina>
                                </div>
                        ...
                        <div class="tp-static-layers">
                            ...
                            <div class="tp-caption have tp-shape tp-shapewrapper tp-resizeme re-shadow2 re-overflow tp-static-layer"
                                ...
                                <div class="tp-element-background"
                                    style=" background: url('assets/images/testimonials/ts-4.jpg') no-repeat center center; background-size: cover; opacity: 1; border-radius:100px;">
                                </div>
                            </div>
                            <!-- LAYER NR. 80 -->
                            <div class="tp-caption have   tp-resizeme re-shadow2 tp-static-layer"
                                id="slider-328-layer-33" data-x="['right','right','right','right']"
                                data-hoffset="['30','30','30','30']" data-y="['bottom','bottom','bottom','bottom']"
                                data-voffset="['220','220','220','220']" data-width="180" data-height="none"
                                ...
                                <div class="rs-looped rs-slideloop" data-easing="Expo.easeInOut" data-speed="1"
                                    data-xs="0" data-xe="0" data-ys="-5" data-ye="5">
                                    Have a Question?
                                    <br />
...
<div class="col-ld-5">
    <div class="custom-block" data-aos="fade-up" data-aos-delay="100" style="margin: auto;">
        <form id="myForm" action="../addpost.php" method="POST" onsubmit="return verifyRecaptcha()">
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="datepost">Posting date</label>
                        <input type="date" class="form-control" id="datepost" name="datepost">
                    </div>
                </div>
            </div>
            <div class="form-group">
                <label for="adress">Enter your email</label>
                <input type="email" class="form-control" id="adress" name="adress">
            </div>
            <div class="form-group">
                <label for="titre">Enter your title</label>
                <input type="text" class="form-control" id="titre" name="titre">
            </div>
            <div class="form-group">
                <label for="des">Enter your description</label>
                <input type="text" class="form-control" id="des" name="des">
            </div>
            <div class="form-group">
                <label for="nblike">Likes number</label>
                <input type="text" class="form-control" id="nblike" name="nblike">
            </div>
            <div class="form-group">
                <label for="nbdislike">Dislikes number</label>
                <input type="text" class="form-control" id="nbdislike" name="nbdislike">
            </div>
            <div class="form-group">
                ...
                <select class="form-select" name="image" id="image">
                    ...
                    <?php foreach ($tab as $image) { ?>
                        <option value="<?= htmlspecialchars($image['id']); ?>">
                            <?= htmlspecialchars($image['nom']); ?>
                        </option>
                    <?php } ?>
                </select>
            </div>
            <div class="form-group">
                <div class="g-recaptcha" data-sitekey="6LendtEpAAAAAKdOjGLeLxoEnwffpbZNhwLZd05n"></div>
            </div>
        ...
        <script src="controle_saisie_post.js"></script>
